// agency_in_house_ongoing_social_sciences_form.js
document.addEventListener("DOMContentLoaded", () => {
  ...
  const STORAGE_KEYS = [
    "ongoing_social_sciences_review_draft_" + proposalId,
    "agencyOngoingSocialReviewDraft:" + proposalId,
    "fm013_ongoing_social_sciences_draft_" + proposalId
  ];

  const PRINT_PAGE = "agency_in_house_ongoing_social_sciences_print.html";
