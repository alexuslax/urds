// agency_in_house_completed_natural_sciences_form.js
document.addEventListener("DOMContentLoaded", () => {
  ...
  const STORAGE_KEYS = [
    "completed_natural_sciences_review_draft_" + proposalId,
    "agencyCompletedNaturalReviewDraft:" + proposalId,
    "fm014_completed_natural_sciences_draft_" + proposalId
  ];

  const PRINT_PAGE = "agency_in_house_completed_natural_sciences_print.html";
  ...
  function previewPrint() {
    saveDraft();
    window.location.href = PRINT_PAGE + "?id=" + encodeURIComponent(proposalId);
  }
