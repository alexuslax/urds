// agency_in_house_ongoing_natural_sciences_form.js
document.addEventListener("DOMContentLoaded", () => {
  ...
  const STORAGE_KEYS = [
    "ongoing_natural_sciences_review_draft_" + proposalId,
    "agencyOngoingNaturalReviewDraft:" + proposalId,
    "fm012_ongoing_natural_sciences_draft_" + proposalId
  ];

  const PRINT_PAGE = "agency_in_house_ongoing_natural_sciences_print.html";

  const technologyRows = [
    {
      letter: "a.",
      label: "Technology Generation (TG)",
      prefix: "tg"
    },
    {
      letter: "b.",
  ...
  function getFormData() {
    ...
    data.recommend_continuation = qs("recommend_continuation")?.checked || false;
    data.recommend_suspension = qs("recommend_suspension")?.checked || false;
    data.recommend_termination = qs("recommend_termination")?.checked || false;
